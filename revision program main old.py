...
def revision_program():
    ...
    def revision():
        ...
        def progress():
            ...
            x=0
            global topic_one_progress, topic_two_progress, topic_three_progress
            for line in file_progress:
                parts=line.split(";")
                if x==0:
                    global topic_one_progress
                    topic_one_progress=parts
                    print (topic_one_progress)
                if x==1:
                    global topic_two_progress
                    topic_two_progress=parts
                    print(topic_two_progress)
                if x==2:
                    global topic_three_progress
...
#also make minigames against computer for complexity
    ...
    def create_pet():
        ...
        button_create_pet=Button(canvas, text="Create Pet", command=save_pet1, fg="black", bg="lavender", font=buttonfontsize)
    ...
    def help_guide():
        ...
        for label in canvas.winfo_children():
            label.destroy()
        #making the buttons and labels
        button_home=Button(canvas, text="Home", command=revision_program, fg="black", bg="lavender",
                           font=buttonfontsize)
        button_home.place(relx=0.1,rely=0.9, anchor="center")
        button_settings=Button(canvas, text="Settings", command=settings, fg="black", bg="lavender",
                               font=buttonfontsize)
        button_settings.place(relx=0.9,rely=0.9, anchor="center")
