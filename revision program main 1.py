...
def revision_program():
    ...
    def revision():
        ...
        def flashcards():
            ...
            intro_title = Label(root, text=title,bg="lavender", fg="black", font=titlefontsize)
            intro_title.place(relx=0.5, rely=0.2, anchor="center")   
            button_settings=Button(root, text="Settings", command=settings, fg="black", bg="lavender", font=buttonfontsize)
            button_settings.place(relx=0.9,rely=0.9, anchor="center")
            button_home=Button(root, text="Home", command=revision_program, fg="black", bg="lavender", font=buttonfontsize)
        ...
        intro_title = Label(root, text="Computer Science Revision Program", bg="lavender", fg="black", font=titlefontsize)
        intro_title.place(relx=0.5, rely=0.2, anchor="center")
        intro_label=Label(root, text = "Choose your topic and mode",bg="lavender", fg="black", font=subtitlefontsize)
        ...
        drop1=OptionMenu(root,clicked_topic, *topic_choice)
        drop1.place(relx=0.5,rely=0.5, anchor="center")
        drop2=OptionMenu(root,clicked_method, *method_choice)
        drop2.place(relx=0.5, rely=0.6, anchor="center")
        button_selection=Button(root, text="Confirm your choices",command=change_topic)
